...
import QuizAdvantureOrigenProdactScreen from './Screen/QuizAdvantureOrigenProdactScreen';
...
function App() {
  ...
  OneSignal.initialize('5912e7a4-e223-49a5-ad34-da4b3dbfc31a');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="QuizAdvantureOrigenProdactScreen"
            component={QuizAdvantureOrigenProdactScreen}
